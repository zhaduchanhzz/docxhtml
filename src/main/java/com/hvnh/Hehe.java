...
//        String inputPath = "inputCV.docx";
//        String outputHtmlPath = "merged_output.pdf";
//
//        Document original = new Document();
//        original.loadFromFile(inputPath);
//        original.saveToFile(outputHtmlPath, FileFormat.PDF);
//        original.saveToFile(outputHtmlPath);
//
//
//        System.out.println(" ✅ Merged HTML written to " + outputHtmlPath);
//    }
    public static void main(String[] args) {
        String inputPath = "inputCV.pdf";
        String outputPath = "htmlfixedCV.html";

        try {
            byte[] inputBytes = Files.readAllBytes(Paths.get(inputPath));
            byte[] htmlBytes = convertDocToHtml(inputBytes);
            Files.write(Paths.get(outputPath), htmlBytes);
    ...
    public static byte[] convertDocToHtml(byte[] inputBytes) throws IOException {
        ...
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(inputBytes)) {
            ...
            document.loadFromFile("inputCV.docx", FileFormat.Docx_2016);
