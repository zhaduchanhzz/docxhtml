...
////        String hashValue = Base64.getEncoder().encodeToString(container.getDocumentHash());
////
////        //Kết quả ký của api /sign
...
////
////        //kiểm tra xem có kết quả ký có match với nhau không
////        container.checkHashSignature(container.getAuthenticatedAttributes(),DigestAlgorithms.SHA256,signature,getCertBase64());
//
//    /// /        container.sign()
////        // ===== 7. Deferred signing (GẮN CHỮ KÝ) =====
////        byte[] pkcs7 = Base64.getDecoder().decode(signatureBase64);
////
////        PdfDocument pdfDoc = new PdfDocument(
////                new PdfReader(new ByteArrayInputStream(tempPdf)),
////                new PdfWriter("signed.pdf")
////        );
////
////        IExternalSignatureContainer postSignContainer =
...
//                .setReason("Ký duyệt văn bản")
//                .setLocation("Hà Nội, Việt Nam")
//                .setContact("nguyenvana@example.com")
//                .setReuseAppearance(false);
//
//        Rectangle rect = new Rectangle(36, 650, 200, 100);
//        appearance.setPageRect(rect);
//        appearance.setPageNumber(1);
//
...
//
//        // =====================================================
//        // 3. PRE-SIGN (tạo placeholder + hash)
//        // =====================================================
//        Certificate[] certChain = getCertChainFromApizz(); // cert chain base64 -> X509Certificate
//
//        PreSignContainer preSignContainer = new PreSignContainer(
//                DigestAlgorithms.SHA256,
//                certChain
//        );
//        byte[] documentHash = pdfInput;
...
//        byte[] pkcs7Signature = Base64.getDecoder().decode(signatureResponse.getSignedData());
//
...
//        );
//
//        int estimatedSize = calculateEstimatedSignatureSize(
//                certChain,
//                tsaClient,
//                null,
//                null
...
//
//        byte[] presignedPdf = presignOut.toByteArray();
//        Files.write(Paths.get("presigned.pdf"), presignedPdf);
//
//        // =====================================================
//        // 4. GỬI HASH ĐI KÝ
//        // =====================================================
//
//        System.out.println("Document hash (Base64): " + hashBase64);
//
//        // API PHẢI TRẢ PKCS#7 detached (Base64)
//
//        // =====================================================
//        // 5. (OPTIONAL) CHECK HASH – DEBUG
//        // =====================================================
//        preSignContainer.checkHashSignature(
//                preSignContainer.getAuthenticatedAttributes(),
//                DigestAlgorithms.SHA256,
//                signatureResponse.getSignedData(),
//                getCertBase64()
//        );
//
//        // =====================================================
//        // 6. DEFERRED SIGNING (GẮN CHỮ KÝ)
//        // =====================================================
//        PdfDocument pdfDoc = new PdfDocument(
...
//
//        IExternalSignatureContainer postSignContainer =
//                new PostSignContainer(pkcs7Signature);
//
//        PdfSigner.signDeferred(
//                pdfDoc,
//                fieldName,
...
//        );
//
//        System.out.println("✅ Ký số hoàn tất: signed.pdf");
//    }
//
...
//    }
//
//    static Certificate[] getCertChainFromApizz() throws Exception {
//
//        HttpClient client = HttpClient.newHttpClient();
//
//        // ===== Request body =====
...
//    }
//
//    private static String getCertBase64() throws Exception {
//
//        HttpClient client = HttpClient.newHttpClient();
//
//        // ===== Request body =====
