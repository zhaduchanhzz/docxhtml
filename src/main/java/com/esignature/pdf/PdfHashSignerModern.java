...
////            ExternalSignatureStub containerStub = new ExternalSignatureStub();
////            signer.signDetached(
////                    new BouncyCastleDigest(),
////                    containerStub,   // stub → chỉ để tạo hash
////                    certChain,
////                    null,
////                    null,
////                    tsaClient,
...
////            );
////            documentHash = containerStub.getSignedBytes();
...
//////            documentHash = DigestAlgorithms.digest(inp, digest.getMessageDigest(HASH_ALGORITHM));
...
//
//            signer.setFieldName(
//                    signatureFieldName != null ? signatureFieldName : generateUniqueFieldName()
//            );
//
//            // ---------------- HASH CONTAINER ----------------
//            HashOnlyExternalContainer container =
//                    new HashOnlyExternalContainer(
//                            certChain,
//                            HASH_ALGORITHM,
//                            signingTime
//                    );
...
//
//            // ---------------- OUTPUT ----------------
//            this.documentHash = container.getDocumentHash();
//            this.secondHash = container.getSecondHash();
//            this.tempPdf = baos.toByteArray();
//        }
//    }
//
...
//        @Override
//        public byte[] sign(byte[] data) throws GeneralSecurityException {
//            // THIS is the range stream (equivalent to getRangeStream)
//            try {
//                signedBytes = DigestAlgorithms.digest(new ByteArrayInputStream(data), MessageDigest.getInstance(DigestAlgorithms.SHA256));
//            } catch (IOException e) {
//                throw new RuntimeException(e);
//            }
//
//            // send signedBytes to HSM / remote service / custom signer
//            return signedBytes;
//        }
